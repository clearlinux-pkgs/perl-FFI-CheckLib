...
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/FFI-CheckLib-0.26.tar.gz
...
%prep
%setup -q -n FFI-CheckLib-0.26
cd %{_builddir}/FFI-CheckLib-0.26
...
cp %{_builddir}/FFI-CheckLib-0.26/LICENSE %{buildroot}/usr/share/package-licenses/perl-FFI-CheckLib/8c55a3fb07df5b7d899c736fabd29f2dc765210c
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.2/FFI/CheckLib.pm
