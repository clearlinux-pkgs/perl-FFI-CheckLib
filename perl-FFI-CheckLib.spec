...
%prep
%setup -q -n FFI-CheckLib-0.28
cd %{_builddir}/FFI-CheckLib-0.28
...
cp %{_builddir}/FFI-CheckLib-0.28/LICENSE %{buildroot}/usr/share/package-licenses/perl-FFI-CheckLib/8c55a3fb07df5b7d899c736fabd29f2dc765210c
if test -f Makefile.PL; then
